...
- `skill-trees/`: skill tree definitions and `index.json`.
...
- `quests/index.json`, `dialogs/index.json`, `items/index.json`, and `skill-trees/index.json` are 
generated by the Gradle asset index tasks (for example `genAssetIndexes`) and are gitignored.
