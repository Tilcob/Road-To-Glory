...
public class MoveIntentSystem extends IteratingSystem {
    private final Vector2 desired = new Vector2();

    public MoveIntentSystem() {
        super(Family.all(MoveIntent.class, Move.class, Transform.class).exclude(Npc.class).get());
    }
